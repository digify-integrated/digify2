...
<body>
            ...
            <div class="body-wrapper">
                <div class="container-fluid">
                    <?php 
                        ...
                        if($newRecord){
                            require_once('components/client/view/_client_new.php');
                        }
                        else if(!empty($detailID)){
                            require_once('components/client/view/_client_details.php');
                        }
                        else{
                            require_once('components/client/view/_client.php');
                        }
                    ?>
                </div>
    ...
    <?php
        $scriptLink = 'client.js';

        if($newRecord){
            $scriptLink = 'client-new.js';
        }
        else if(!empty($detailID)){
            $scriptLink = 'client-details.js';
        }

        echo '<script src="./components/client/js/'. $scriptLink .'?v=' . rand() .'"></script>';
    ?>
</body>
