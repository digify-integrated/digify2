...
<body>
            ...
            <div class="body-wrapper">
                <div class="container-fluid">
                    <?php 
                        ...
                        if($newRecord){
                            require_once('components/carousel/view/_carousel_new.php');
                        }
                        else if(!empty($detailID)){
                            require_once('components/carousel/view/_carousel_details.php');
                        }
                        else{
                            require_once('components/carousel/view/_carousel.php');
                        }
                    ?>
                </div>
    ...
    <?php
        $scriptLink = 'carousel.js';

        if($newRecord){
            $scriptLink = 'carousel-new.js';
        }
        else if(!empty($detailID)){
            $scriptLink = 'carousel-details.js';
        }

        echo '<script src="./components/carousel/js/'. $scriptLink .'?v=' . rand() .'"></script>';
    ?>
</body>
