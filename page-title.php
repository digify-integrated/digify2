...
<body>
            ...
            <div class="body-wrapper">
                <div class="container-fluid">
                    <?php 
                        ...
                        if($newRecord){
                            require_once('components/page-title/view/_page_title_new.php');
                        }
                        else if(!empty($detailID)){
                            require_once('components/page-title/view/_page_title_details.php');
                        }
                        else{
                            require_once('components/page-title/view/_page_title.php');
                        }
                    ?>
                </div>
    ...
    <?php
        $scriptLink = 'page-title.js';

        if($newRecord){
            $scriptLink = 'page-title-new.js';
        }
        else if(!empty($detailID)){
            $scriptLink = 'page-title-details.js';
        }

        echo '<script src="./components/page-title/js/'. $scriptLink .'?v=' . rand() .'"></script>';
    ?>
</body>
