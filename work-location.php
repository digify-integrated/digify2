...
<body>
            ...
            <div class="body-wrapper">
                <div class="container-fluid">
                    <?php 
                        ...
                        if($newRecord){
                            require_once('components/work-locations/view/_work_locations_new.php');
                        }
                        else if(!empty($detailID)){
                            require_once('components/work-locations/view/_work_locations_details.php');
                        }
                        else{
                            require_once('components/work-locations/view/_work_locations.php');
                        }
                    ?>
                </div>
    ...
    <?php
        $scriptLink = 'work-locations.js';

        if($newRecord){
            $scriptLink = 'work-locations-new.js';
        }
        else if(!empty($detailID)){
            $scriptLink = 'work-locations-details.js';
        }

        echo '<script src="./components/work-locations/js/'. $scriptLink .'?v=' . rand() .'"></script>';
    ?>
</body>
