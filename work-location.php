...
<body>
            ...
            <div class="body-wrapper">
                <div class="container-fluid">
                    <?php 
                        ...
                        if($newRecord){
                            require_once('components/work-location/view/_work_location_new.php');
                        }
                        else if(!empty($detailID)){
                            require_once('components/work-location/view/_work_location_details.php');
                        }
                        else{
                            require_once('components/work-location/view/_work_location.php');
                        }
                    ?>
                </div>
    ...
    <?php
        $scriptLink = 'work-location.js';

        if($newRecord){
            $scriptLink = 'work-location-new.js';
        }
        else if(!empty($detailID)){
            $scriptLink = 'work-location-details.js';
        }

        echo '<script src="./components/work-location/js/'. $scriptLink .'?v=' . rand() .'"></script>';
    ?>
</body>
