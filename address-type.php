...
<body>
            ...
            <div class="body-wrapper">
                <div class="container-fluid">
                    <?php 
                        ...
                        if($newRecord){
                            require_once('components/address-type/view/_address_type_new.php');
                        }
                        else if(!empty($detailID)){
                            require_once('components/address-type/view/_address_type_details.php');
                        }
                        else{
                            require_once('components/address-type/view/_address_type.php');
                        }
                    ?>
                </div>
    ...
    <?php
        $scriptLink = 'address-type.js';

        if($newRecord){
            $scriptLink = 'address-type-new.js';
        }
        else if(!empty($detailID)){
            $scriptLink = 'address-type-details.js';
        }

        echo '<script src="./components/address-type/js/'. $scriptLink .'?v=' . rand() .'"></script>';
    ?>
</body>
