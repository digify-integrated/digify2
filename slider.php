...
<body>
            ...
            <div class="body-wrapper">
                <div class="container-fluid">
                    <?php 
                        ...
                        if($newRecord){
                            require_once('components/slider/view/_slider_new.php');
                        }
                        else if(!empty($detailID)){
                            require_once('components/slider/view/_slider_details.php');
                        }
                        else{
                            require_once('components/slider/view/_slider.php');
                        }
                    ?>
                </div>
    ...
    <?php
        $scriptLink = 'slider.js';

        if($newRecord){
            $scriptLink = 'slider-new.js';
        }
        else if(!empty($detailID)){
            $scriptLink = 'slider-details.js';
        }

        echo '<script src="./components/slider/js/'. $scriptLink .'?v=' . rand() .'"></script>';
    ?>
</body>
