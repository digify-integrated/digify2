...
<body>
            ...
            <div class="body-wrapper">
                <div class="container-fluid">
                    <?php 
                        ...
                        if($newRecord){
                            require_once('components/email-setting/view/_email_setting_new.php');
                        }
                        else if(!empty($detailID)){
                            require_once('components/email-setting/view/_email_setting_details.php');
                        }
                        else{
                            require_once('components/email-setting/view/_email_setting.php');
                        }
                    ?>
                </div>
    ...
    <?php
        $scriptLink = 'email-setting.js';

        if($newRecord){
            $scriptLink = 'email-setting-new.js';
        }
        else if(!empty($detailID)){
            $scriptLink = 'email-setting-details.js';
        }

        echo '<script src="./components/email-setting/js/'. $scriptLink .'?v=' . rand() .'"></script>';
    ?>
</body>
