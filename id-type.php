...
<body>
            ...
            <div class="body-wrapper">
                <div class="container-fluid">
                    <?php 
                        ...
                        if($newRecord){
                            require_once('components/id-type/view/_id_type_new.php');
                        }
                        else if(!empty($detailID)){
                            require_once('components/id-type/view/_id_type_details.php');
                        }
                        else{
                            require_once('components/id-type/view/_id_type.php');
                        }
                    ?>
                </div>
    ...
    <?php
        $scriptLink = 'id-type.js';

        if($newRecord){
            $scriptLink = 'id-type-new.js';
        }
        else if(!empty($detailID)){
            $scriptLink = 'id-type-details.js';
        }

        echo '<script src="./components/id-type/js/'. $scriptLink .'?v=' . rand() .'"></script>';
    ?>
</body>
