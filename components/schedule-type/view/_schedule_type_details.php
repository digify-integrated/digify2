    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header d-flex align-items-center">
                <h5 class="card-title mb-0">Schedule Type</h5>
                <div class="card-actions cursor-pointer ms-auto d-flex button-group">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        <?php
                           echo $createAccess['total'] > 0 ? '<li><a class="dropdown-item" href="'. $pageLink .'&new">Create Schedule Type</a></li>' : '';
                           echo $deleteAccess['total'] > 0 ? '<li><button class="dropdown-item" type="button" id="delete-schedule-type">Delete Schedule Type</button></li>' : '';
                        ?>
                    </ul>
                </div>
                <?php
                    echo $writeAccess['total'] > 0 ? '<div class="card-actions cursor-pointer ms-auto d-flex button-group">
                                                            <button class="btn btn-info mb-0 px-4" data-bs-toggle="modal" id="edit-details" data-bs-target="#schedule-type-modal">Edit</button>
                                                        </div>' : '';
                ?>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-12 mb-3">
                        ...
                        <h6 class="fw-semibold mb-0" id="schedule_type_name_summary">--</h6>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="modal-dialog modal-dialog-scrollable modal-r">
        <div class="modal-content">
            ...
            <div class="modal-footer border-top">
                ...
                <button type="submit" form="schedule-type-form" class="btn btn-success" id="submit-data">Save changes</button>
            </div>
        </div>
    </div>
</div>
