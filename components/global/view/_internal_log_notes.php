    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="tab-content" id="logs-tabContent">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-floating mb-3">
                                                <textarea class="form-control maxlength" id="internal_note" name="internal_note" placeholder="Internal notes" rows="5" maxlength="5000"></textarea>
                ...
                <div class="tab-pane fade" id="pills-log-notes" role="tabpanel" aria-labelledby="pills-log-notes-tab" tabindex="0">
                    <div class="row">
