...
# Description: 
# The Services BoxController class handles carousel related operations and interactions.
#
# Parameters: None
#
# Returns: None
...
class ServicesBoxController {
    ...
    # These instances are used for services box related, user related operations and security related operations, respectively.
    #
    # Parameters:
    # - @param ServicesBoxModel $servicesBoxModel     The servicesBoxModel instance for services box related operations.
    ...
    public function handleRequest(){
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            switch ($transaction) {
                case 'add services box':
                    $this->addServicesBox();
                    break;
                case 'update services box':
                    $this->updateServicesBox();
                    break;
                case 'save services box item':
                ...
                case 'get services box item details':
                    ...
                    break;
                case 'publish services box':
                    $this->publishServicesBox();
                    break;
                case 'unpublish services box':
                    $this->unpublishServicesBox();
                    break;
                case 'delete services box':
                    $this->deleteServicesBox();
                    break;
                case 'delete services box item':
                    $this->deleteServicesBoxItem();
                    break;
                case 'delete multiple services box':
    ...
    public function addServicesBox() {
        ...
        if (isset($_POST['services_box_name']) && !empty($_POST['services_box_name']) && isset($_POST['block_style_id']) && !empty($_POST['block_style_id']) && isset($_POST['description']) && !empty($_POST['description'])) {
            $userID = $_SESSION['user_account_id'];
            $servicesBoxName = $_POST['services_box_name'];
            ...
            $response = [
                ...
                'title' => 'Insert Services Box Success',
                'message' => 'The services box has been inserted successfully.',
                'messageType' => 'success'
            ];
    ...
    # Description: 
    # Updates the services box if it exists; otherwise, return an error message.
    #
    # Parameters: None
    #
    # Returns: Array
    ...
    public function updateServicesBox() {
        ...
        if (isset($_POST['services_box_name']) && !empty($_POST['services_box_name']) && isset($_POST['block_style_id']) && !empty($_POST['block_style_id']) && isset($_POST['description']) && !empty($_POST['description'])) {
            $userID = $_SESSION['user_account_id'];
            $servicesBoxID = htmlspecialchars($_POST['services_box_id'], ENT_QUOTES, 'UTF-8');
            $servicesBoxName = $_POST['services_box_name'];
            $blockStyleID = htmlspecialchars($_POST['block_style_id'], ENT_QUOTES, 'UTF-8');
            $description = $_POST['description'];
            ...
            if($total === 0){
                $response = [
                    'success' => false,
                    'notExist' => true,
                    'title' => 'Update Services Box Error',
                    'message' => 'The services box does not exist.',
                    'messageType' => 'error'
                ];
            ...
            $response = [
                'success' => true,
                'title' => 'Update Services Box Success',
                'message' => 'The services box has been updated successfully.',
                'messageType' => 'success'
            ];
    ...
    # Description: 
    # Updates the services box if it exists; otherwise, insert.
    #
    # Parameters: None
    #
    # Returns: Array
    ...
    public function saveServicesBoxItem() {
        ...
        if (isset($_POST['services_box_item_id']) && isset($_POST['services_box_id']) && !empty($_POST['services_box_id']) && isset($_POST['order_sequence']) && !empty($_POST['order_sequence'])) {
            $userID = $_SESSION['user_account_id'];
            $servicesBoxItemID = htmlspecialchars($_POST['services_box_item_id'], ENT_QUOTES, 'UTF-8');
            $servicesBoxID = htmlspecialchars($_POST['services_box_id'], ENT_QUOTES, 'UTF-8');
            $servicesBoxTitle = $_POST['services_box_title'];
            $servicesBoxHeading = $_POST['services_box_heading'];
            $servicesBoxParagraph = $_POST['services_box_paragraph'];
            ...
            if($total === 0){
                $response = [
                    'success' => false,
                    'notExist' => true,
                    'title' => 'Save Services Box Item Error',
                    'message' => 'The services box does not exist.',
                    'messageType' => 'error'
                ];
            ...
            if($total > 0){
                $servicesBoxImageFileName = $_FILES['services_box_image']['name'];
                $servicesBoxImageFileSize = $_FILES['services_box_image']['size'];
                $servicesBoxImageFileError = $_FILES['services_box_image']['error'];
                $servicesBoxImageTempName = $_FILES['services_box_image']['tmp_name'];
                ...
                if (!empty($servicesBoxImageFileName) && $servicesBoxImageFileSize > 0) {
                    ...
                    if (!in_array($servicesBoxImageActualFileExtension, $allowedFileExtensions)) {
                        $response = [
                            'success' => false,
                            'title' => 'Update Services Box Item Error',
                    ...
                    if(empty($servicesBoxImageTempName)){
                        $response = [
                            'success' => false,
                            'title' => 'Update Services Box Item Error',
                            'message' => 'Please choose the services box item.',
                            'messageType' => 'error'
                        ];
                    ...
                    $filePath = './components/services-box/image/'. $servicesBoxID . '/' . $fileNew;
                    ...
                    $servicesBoxImagePath = !empty($servicesBoxItemDetails['services_box_image']) ? str_replace('./components/', '../../', $servicesBoxItemDetails['services_box_image']) : null;
                    ...
                    if(file_exists($servicesBoxImagePath)){
                        if (!unlink($servicesBoxImagePath)) {
                            $response = [
                                'success' => false,
                                'title' => 'Update Services Box Item Error',
                                'message' => 'The services box item cannot be deleted due to an error.',
                                'messageType' => 'error'
                            ];
                    ...
                    if(!move_uploaded_file($servicesBoxImageTempName, $fileDestination)){
                        $response = [
                            'success' => false,
                            'title' => 'Update Services Box Item Error',
                            'message' => 'The services box item cannot be uploaded due to an error.',
                            'messageType' => 'error'
                        ];
                    ...
                    $response = [
                        'success' => true,
                        'title' => 'Update Services Box Item Success',
                        'message' => 'The services box item has been inserted successfully.',
                        'messageType' => 'success'
                    ];
                ...
                if (!in_array($servicesBoxImageActualFileExtension, $allowedFileExtensions)) {
                    $response = [
                        'success' => false,
                        'title' => 'Insert Services Box Item Error',
                        'message' => 'The file uploaded is not supported.',
                        'messageType' => 'error'
                    ];
                ...
                $response = [
                    'success' => true,
                    'title' => 'Insert Services Box Item Success',
                    'message' => 'The services box item has been inserted successfully.',
                    'messageType' => 'success'
                ];
    ...
    # Description: 
    # Publish the services box if it exists; otherwise, return an error message.
    #
    # Parameters: None
    #
    # Returns: Array
    ...
    public function publishServicesBox() {
        ...
        if (isset($_POST['services_box_id']) && !empty($_POST['services_box_id'])) {
            $userID = $_SESSION['user_account_id'];
            $servicesBoxID = htmlspecialchars($_POST['services_box_id'], ENT_QUOTES, 'UTF-8');
            ...
            if($total === 0){
                $response = [
                    'success' => false,
                    'notExist' => true,
                    'title' => 'Publish Services Box Error',
                    'message' => 'The services box does not exist.',
                    'messageType' => 'error'
                ];
            ...
            $response = [
                'success' => true,
                'title' => 'Publish Services Box Success',
                'message' => 'The services box has been published successfully.',
                'messageType' => 'success'
            ];
        ...
        if (isset($_POST['services_box_id']) && !empty($_POST['services_box_id'])) {
            ...
            if($total === 0){
                $response = [
                    'success' => false,
                    'notExist' => true,
                    'title' => 'Unpublish Services Box Error',
                    'message' => 'The services box does not exist.',
                    'messageType' => 'error'
                ];
            ...
            $response = [
                'success' => true,
                'title' => 'Unpublish Services Box Success',
                'message' => 'The services box has been unpublished successfully.',
                'messageType' => 'success'
            ];
    ...
    # Description: 
    # Delete the services box if it exists; otherwise, return an error message.
    #
    # Parameters: None
    #
    # Returns: Array
        ...
        if (isset($_POST['services_box_id']) && !empty($_POST['services_box_id'])) {
            ...
            if($total === 0){
                $response = [
                    'success' => false,
                    'notExist' => true,
                    'title' => 'Delete Services Box Error',
                    'message' => 'The services box does not exist.',
                    'messageType' => 'error'
                ];
            ...
            foreach ($servicesBoxItemByCourselDetails as $row) {
                $servicesBoxImagePath = !empty($row['services_box_image']) ? str_replace('./components/', '../../', $row['services_box_image']) : null;

                if(file_exists($servicesBoxImagePath)){
                    if (!unlink($servicesBoxImagePath)) {
                        $response = [
                            'success' => false,
                            'title' => 'Delete Services Box Item Error',
                            'message' => 'The services box item cannot be deleted due to an error.',
                            'messageType' => 'error'
                        ];
            ...
            $response = [
                'success' => true,
                'title' => 'Delete Services Box Success',
                'message' => 'The services box has been deleted successfully.',
                'messageType' => 'success'
            ];
    ...
    public function deleteServicesBoxItem() {
        ...
        if (isset($_POST['services_box_item_id']) && !empty($_POST['services_box_item_id'])) {
            $servicesBoxItemID = htmlspecialchars($_POST['services_box_item_id'], ENT_QUOTES, 'UTF-8');
            ...
            if($total === 0){
                $response = [
                    'success' => false,
                    'title' => 'Delete Services Box Item Error',
                    'message' => 'The services box item does not exist.',
                    'messageType' => 'error'
                ];
            ...
            $response = [
                'success' => true,
                'title' => 'Delete Services Box Item Success',
                'message' => 'The services box item has been deleted successfully.',
                'messageType' => 'success'
            ];
    ...
    # Description: 
    # Delete the selected services boxs if it exists; otherwise, skip it.
    #
    # Parameters: None
    #
    # Returns: Array
    ...
    public function deleteMultipleServicesBox() {
        ...
        if (isset($_POST['services_box_id']) && !empty($_POST['services_box_id'])) {
            $servicesBoxIDs = $_POST['services_box_id'];
            ...
            $response = [
                'success' => true,
                'title' => 'Delete Multiple Services Boxs Success',
                'message' => 'The selected services boxs have been deleted successfully.',
                'messageType' => 'success'
            ];
    ...
    # Description: 
    # Handles the retrieval of services box details.
    #
    # Parameters: None
    #
    # Returns: Array
        ...
        if (isset($_POST['services_box_id']) && !empty($_POST['services_box_id'])) {
            ...
            if($total === 0){
                $response = [
                    'success' => false,
                    'notExist' => true,
                    'title' => 'Get Services Box Details Error',
                    'message' => 'The services box does not exist.',
                    'messageType' => 'error'
                ];
            ...
            $response = [
                'success' => true,
                'servicesBoxName' => $servicesBoxDetails['services_box_name'] ?? null,
    ...
    # Description: 
    # Handles the retrieval of services box item details.
    #
    # Parameters: None
    #
    # Returns: Array
    ...
    public function getServicesBoxItemDetails() {
        ...
        if (isset($_POST['services_box_item_id']) && !empty($_POST['services_box_item_id'])) {
            ...
            if($total === 0){
                $response = [
                    'success' => false,
                    'title' => 'Get Services Box Item Details Error',
                    'message' => 'The services box item does not exist.',
                    'messageType' => 'error'
                ];
            ...
            $response = [
                'success' => true,
                'servicesBoxTitle' => $servicesBoxItemDetails['services_box_title'] ?? null,
                'servicesBoxHeading' => $servicesBoxItemDetails['services_box_heading'] ?? null,
                'servicesBoxParagraph' => $servicesBoxItemDetails['services_box_paragraph'] ?? null,
