                ...
                <?php
                    echo $deleteAccess['total'] > 0 ? '<button type="button" class="btn btn-dark dropdown-toggle action-dropdown mb-0 d-none" data-bs-toggle="dropdown" aria-expanded="false">Action</button>
                                                        <ul class="dropdown-menu dropdown-menu-end">
                                                            <li><button class="dropdown-item" type="button" id="delete-employment-location-type">Delete Employment Location Type</button></li>
                                                        </ul>' : '';
            ...
            <div class="card mb-0">
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="employment-location-type-table" class="table search-table align-middle text-nowrap w-100 mb-4">
