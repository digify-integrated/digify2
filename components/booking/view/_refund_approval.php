            ...
            <div class="card mb-0">
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="refund-approval-table" class="table align-middle text-nowrap w-100 mb-0">
...
<div class="offcanvas offcanvas-start" tabindex="-1" id="filter-offcanvas" aria-labelledby="filter-offcanvas-label">
    ...
    <div class="offcanvas-body p-0">
        ...
        <div class="border-bottom rounded-0">
            <h6 class="mt-4 mb-3 mx-4 fw-semibold">By Booking Status</h6>
            <div class="pb-4 px-4 text-dark" id="booking-status-filter">
                <select class="form-control" id="filter_by_booking_status" name="filter_by_booking_status">
