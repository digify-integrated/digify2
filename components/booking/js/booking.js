(function($) {
    ...
    $(function() {
        ...
        if($('#cancellation-approval-table').length){
            cancellationApprovalTable('#cancellation-approval-table');
        }

        if($('#refund-approval-table').length){
            refundApprovalTable('#refund-approval-table');
        }
        ...
        $('#datatable-search').on('keyup', function () {
            ...
            if($('#cancellation-approval-table').length){
                table = $('#cancellation-approval-table').DataTable();
            }
    
            if($('#refund-approval-table').length){
                table = $('#refund-approval-table').DataTable();
            }
...
function cancellationApprovalTable(datatable_name, buttons = false, show_all = false){
    toggleHideActionDropdown();

    const type = 'booking cancellation approval table';
    const page_id = $('#page-id').val();
    const filter_by_service = $('#filter_by_service').val();
    const filter_by_payment_status = $('#filter_by_payment_status').val();
    const filter_by_mode_of_payment = $('#filter_by_mode_of_payment').val();
...
function refundApprovalTable(datatable_name, buttons = false, show_all = false){
    toggleHideActionDropdown();

    const type = 'booking refund approval table';
    const page_id = $('#page-id').val();
    const filter_by_service = $('#filter_by_service').val();
    const filter_by_booking_status = $('#filter_by_booking_status').val();
    const filter_by_mode_of_payment = $('#filter_by_mode_of_payment').val();
