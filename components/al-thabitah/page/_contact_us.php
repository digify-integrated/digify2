<!-- start page title -->
            ...
            <div class="container">
                <div class="row align-items-center justify-content-center small-screen">
                    <div class="col-xl-5 col-sm-8 page-title-double-large text-center" data-anime='{ "el": "childs", "opacity": [0, 1], "translateY": [30, 0], "duration": 600, "staggervalue": 300, "easing": "easeOutQuad" }'>
                        ...
                        <h2 class="text-white fw-600 ls-1px mb-0 text-uppercase">Let's work together</h2>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container"> 
                ...
                <div class="row row-cols-1 row-cols-xl-4 row-cols-lg-4 row-cols-md-2 row-cols-sm-2 mb-6 sm-mb-8" data-anime='{ "el": "childs", "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay":0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                    ...
                    <div class="col md-mb-30px text-center text-sm-start">
                        ...
                        <a href="/cdn-cgi/l/email-protection#5831363e371821372d2a3c3735393136763b3735"><span class="__cf_email__" data-cfemail="3b52555d547b42544e495f54565a525515585456">[email&#160;protected]</span></a><br>
                        <a href="/cdn-cgi/l/email-protection#394a58555c4a7940564c4b5d5654585057175a5654"><span class="__cf_email__" data-cfemail="4d3e2c21283e0d3422383f2922202c2423632e2220">[email&#160;protected]</span></a>
                    </div>
        ...
        <section class="bg-gradient-quartz-white position-relative z-index-0 sm-pt-0">
            <div class="container-fluid overlap-section p-0">
                <div class="row g-0 justify-content-end overlap-section-one-fourth">
                    <div class="col-md-6">
                        <iframe class="map" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3604.1573681644527!2d55.44695751074672!3d25.399542423382023!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5f582d74e738b9%3A0x4fa51615f1eb3993!2sAl%20Kaabi%20Building!5e0!3m2!1sen!2sph!4v1723798303294!5m2!1sen!2sph" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                    </div>
                </div>
            </div>
        ...
        <!-- start section -->
        <section>
            <div class="container overlap-section overlap-section-three-fourth appear anime-child anime-complete" data-anime="{&quot;el&quot;: &quot;childs&quot;, &quot;translateY&quot;: [50, 0], &quot;opacity&quot;: [0,1], &quot;duration&quot;: 800, &quot;delay&quot;: 500, &quot;staggervalue&quot;: 150, &quot;easing&quot;: &quot;easeOutQuad&quot; }" style="margin-top: -299.758px;"> 
                <div class="row align-items-center justify-content-center">
                    ...
                    <div class="col-md-auto elements-social social-icon-style-04 text-center text-md-start ps-lg-0">
                        <ul class="large-icon dark">
                            <li class="m-0"><a class="facebook" href="https://www.facebook.com/profile.php?id=100095104812245&mibextid=LQQJ4d" target="_blank"><i class="fa-brands fa-facebook-f"></i><span></span></a></li>
                            <li class="m-0"><a class="youtube" href="https://www.youtube.com/channel/UCbzw6RiqwngeeruQwGi58-A" target="_blank"><i class="fa-brands fa-youtube"></i><span></span></a></li>
                            <li class="m-0"><a class="instagram" href="https://www.instagram.com/althabitah.cleaningservices/" target="_blank"><i class="fa-brands fa-instagram"></i><span></span></a></li>      
                            <li class="m-0"><a class="tiktok" href="https://www.tiktok.com/@althabitahcleaningservic?_t=8ohEkhilfXA&_r=1" target="_blank"><i class="fa-brands fa-tiktok"></i><span></span></a></li>
                            <li class="m-0"><a class="whatsapp" href="https://wa.me/971561652741" target="_blank"><i class="fa-brands fa-whatsapp"></i><span></span></a></li>
                        </ul>                  
                    </div>
                    <!-- end social icon -->
                </div>
