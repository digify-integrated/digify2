<?php
    ...
    require_once('page_components/water-tank-cleaning/_water_tank_cleaning_page_title.php');
    require_once('page_components/water-tank-cleaning/_water_tank_cleaning_section.php');
?>