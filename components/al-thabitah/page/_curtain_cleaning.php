<?php
    ...
    require_once('page_components/curtain-cleaning/_curtain_cleaning_page_title.php');
    require_once('page_components/curtain-cleaning/_curtain_cleaning_section.php');
?>