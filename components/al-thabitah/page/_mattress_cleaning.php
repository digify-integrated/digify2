<?php
    ...
    require_once('page_components/mattress-cleaning/_mattress_cleaning_page_title.php');
    require_once('page_components/mattress-cleaning/_mattress_cleaning_section.php');
?>