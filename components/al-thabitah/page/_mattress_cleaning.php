<!-- start page title -->
        <section class="top-space-margin page-title-big-typography cover-background pt-0 pb-0" style="background-image: url(./components/al-thabitah/assets/images/services/mattress-cleaning-01.jpg)">
            <div class="container">
                <div class="row align-items-center justify-content-center small-screen">
                    <div class="col-xl-5 col-sm-8 page-title-double-large text-center" data-anime='{ "el": "childs", "opacity": [0, 1], "translateY": [30, 0], "duration": 600, "staggervalue": 300, "easing": "easeOutQuad" }'>
                        <h1 class="text-base-color fw-700 mb-5px">Mattress Cleaning</h1>
                        <h2 class="text-white fw-600 ls-1px mb-0 text-uppercase">Comprehensive cleaning to ensure a healthier sleep by removing dust mites, stains, and odors</h2>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-8 order-1 order-lg-2 md-mb-50px" data-anime='{ "el": "childs", "translateY": [50, 0], "opacity": [0,1], "duration": 1200, "delay": 0, "staggervalue": 150, "easing": "easeOutQuad" }'>
                        ...
                        <p>Sleep better with AL THABITAH’s Mattress Cleaning Service. Our specialized cleaning process targets dust mites, allergens, and stains that accumulate over time, ensuring a healthier and more comfortable sleep environment. Using eco-friendly products and deep-cleaning techniques, we eliminate hidden contaminants while protecting the integrity of your mattress. Say goodbye to allergens and hello to a fresher, cleaner mattress with AL THABITAH’s professional service.</p>
                        <div class="cover-background p-7 border-radius-6px mb-60px md-mb-40px d-flex justify-content-end align-items-end sm-h-500px" style="background-image: url(./components/al-thabitah/assets/images/services/mattress-cleaning-02.jpg)">
