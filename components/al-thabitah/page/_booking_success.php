<?php
    ...
    if (isset($_GET['session_id']) && !empty($_GET['session_id']) && isset($_GET['booking_id']) && !empty($_GET['booking_id'])) {
        ...
        try {
            \Stripe\Stripe::setApiKey('sk_test_51PnZXm011037BG0D6xoUVs8ivANxguIc4KN9sK5ndjWrSbXcFn1nXDkgg7oL2glDfuyg2DYDxu8AVE9O55yWXW2Z00LNpVfEuu');
            ...
            if ($payment_intent->status === 'succeeded') {
                ...
                $bookingModel->updateBookingPaymentStatus($bookingID, 'Paid', date('Y-m-d H:i:s'), $paymentReferenceNumber, '', '', '', '1');
                // ADD voucher availability updated
