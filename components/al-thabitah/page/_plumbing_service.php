<?php
    ...
    require_once('page_components/plumbing-service/_plumbing_service_page_title.php');
    require_once('page_components/plumbing-service/_plumbing_service_section.php');
?>