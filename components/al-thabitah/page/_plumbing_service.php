<!-- start page title -->
        <section class="top-space-margin page-title-big-typography cover-background pt-0 pb-0" style="background-image: url(./assets/images/services/plumbing-service-01.jpg)">
            <div class="container">
                <div class="row align-items-center justify-content-center small-screen">
                    <div class="col-xl-5 col-sm-8 page-title-double-large text-center" data-anime='{ "el": "childs", "opacity": [0, 1], "translateY": [30, 0], "duration": 600, "staggervalue": 300, "easing": "easeOutQuad" }'>
                        <h1 class="text-base-color fw-700 mb-5px">Plumbing Service</h1>
                        <h2 class="text-white fw-600 ls-1px mb-0 text-uppercase">Quick and efficient plumbing solutions for any issues in your home or office</h2>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-8 order-1 order-lg-2 md-mb-50px" data-anime='{ "el": "childs", "translateY": [50, 0], "opacity": [0,1], "duration": 1200, "delay": 0, "staggervalue": 150, "easing": "easeOutQuad" }'>
                        ...
                        <p>Restore peace of mind to your home with AL THABITAH's Plumbing Service. From leaky faucets to clogged drains, our experienced team is equipped to handle all your plumbing needs efficiently and effectively. With prompt response times and expert troubleshooting, we'll diagnose and resolve any issue with precision. We prioritize quality workmanship and use only the highest quality materials, ensuring long-lasting solutions. Don't let plumbing problems disrupt your daily routine – trust AL THABITAH to keep your pipes flowing smoothly. Experience reliable service and lasting results with AL THABITAH's Plumbing Service.</p>
                        <div class="cover-background p-7 border-radius-6px mb-60px md-mb-40px d-flex justify-content-end align-items-end sm-h-500px" style="background-image: url(./assets/images/services/plumbing-service-02.jpg)">
