    ...
    $(function() {
        ...
        $(document).on('click','#delete-educational-stage',function() {
            ...
            if(educational_stage_id.length > 0){
                ...
                showNotification('Deletion Multiple Educational Stages Error', 'Please select the educational stage you wish to delete.', 'danger');
            }
        });
...
function educationalStageTable(datatable_name, buttons = false, show_all = false){
    ...
    settings = {
        'ajax': { 
            'url' : 'components/educational-stage/view/_educational_stage_generation.php',
            'method' : 'POST',
            'dataType': 'json',
            'data': {
                'type' : type,
