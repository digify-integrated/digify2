            ...
            <div class="card-header d-flex align-items-center">
                ...
                <div class="card-actions cursor-pointer ms-auto d-flex button-group">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        <?php
                            echo $createAccess['total'] > 0 ? '<li><a class="dropdown-item" href="'. $pageLink .'&new">Create File Extension</a></li>' : '';
                            echo $deleteAccess['total'] > 0 ? '<li><button class="dropdown-item" type="button" id="delete-file-extension">Delete File Extension</button></li>' : '';
                        ?>
                    </ul>
                </div>
                <?php
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-6 mb-3">
                        ...
                        <h6 class="fw-semibold mb-0" id="file_extension_name_summary">--</h6>
                    </div>
                    <div class="col-lg-6 mb-3">
                        <p class="mb-1 fs-2">File Extension</p>
                        <h6 class="fw-semibold mb-0" id="file_extension_summary">--</h6>
                    </div>
                    <div class="col-lg-12 mb-0">
                        <p class="mb-1 fs-2">File Type</p>
                        <h6 class="fw-semibold mb-0" id="file_type_summary">--</h6>
                    </div>
                </div>
            </div>
        </div>
