(function($) {
    ...
    $(function() {
        ...
        $(document).on('click','.delete-employment-type',function() {
            const employment_type_id = $(this).data('employment-type-id');
        ...
        $(document).on('click','#delete-employment-type',function() {
            ...
            if(employment_type_id.length > 0){
                ...
                showNotification('Deletion Multiple Employment Types Error', 'Please select the employment types you wish to delete.', 'danger');
            }
        });
...
function employmentTypeTable(datatable_name, buttons = false, show_all = false){
    toggleHideActionDropdown();
