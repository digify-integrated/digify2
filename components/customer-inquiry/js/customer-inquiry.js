(function($) {
    ...
    $(function() {
        ...
        $(document).on('click','.delete-customer-inquiry',function() {
            const customer_inquiry_id = $(this).data('customer-inquiry-id');
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            if (response.success) {
                                ...
                                reloadDatatable('#customer-inquiry-table');
                            }
                            else {
        ...
        $(document).on('click','#delete-customer-inquiry',function() {
            let customer_inquiry_id = [];
            const transaction = 'delete multiple customer inquiry';

            $('.datatable-checkbox-children').each((index, element) => {
                if ($(element).is(':checked')) {
                    customer_inquiry_id.push(element.value);
                }
            });
        ...
        $('#datatable-search').on('keyup', function () {
            var table = $('#customer-inquiry-table').DataTable();
