(function($) {
    ...
    $(function() {
        ...
        $(document).on('click','#tag-as-in-progress',function() {
            const customer_inquiry_id = $('#details-id').text();
            const page_link = document.getElementById('page-link').getAttribute('href');
            const transaction = 'tag customer inquiry as in-progress';
    
            Swal.fire({
                title: 'Confirm Customer Inquiry Tagging As In-Progress',
                text: 'Are you sure you want to tag this customer inquiry as in-progress?',
                icon: 'warning',
                showCancelButton: !0,
        ...
        $(document).on('click','#tag-as-resolved',function() {
            const customer_inquiry_id = $('#details-id').text();
            const page_link = document.getElementById('page-link').getAttribute('href');
            const transaction = 'tag customer inquiry as resolved';
    
            Swal.fire({
                title: 'Confirm Customer Inquiry Tagging As Resolved',
                text: 'Are you sure you want to tag this customer inquiry as resolved?',
                icon: 'warning',
                showCancelButton: !0,
        ...
        $(document).on('click','#tag-as-closed',function() {
            const customer_inquiry_id = $('#details-id').text();
            const page_link = document.getElementById('page-link').getAttribute('href');
            const transaction = 'tag customer inquiry as closed';
    
            Swal.fire({
                title: 'Confirm Customer Inquiry Tagging As Closed',
                text: 'Are you sure you want to tag this customer inquiry as closed?',
                icon: 'warning',
                showCancelButton: !0,
