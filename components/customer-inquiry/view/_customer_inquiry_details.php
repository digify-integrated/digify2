                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        <?php
                            ...
                            if($publishStatus == 'No' && $publishWebsiteElement['total'] > 0){
                                echo '<li><button class="dropdown-item" type="button" id="publish-customer-inquiry">Publish Customer Inquiry</button></li>';
                            }

                            if($publishStatus == 'Yes' && $unpublishWebsiteElement['total'] > 0){
                                echo '<li><button class="dropdown-item" type="button" id="unpublish-customer-inquiry">Unpublish Customer Inquiry</button></li>';
                            }

                            echo $deleteAccess['total'] > 0 && $publishStatus == 'No' ? '<li><button class="dropdown-item" type="button" id="delete-customer-inquiry">Delete Customer Inquiry</button></li>' : '';
                        ?>
                    </ul>
                </div>
                <?php
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-6 mb-3">
                        ...
                        <h6 class="fw-semibold mb-0" id="customer_inquiry_name_summary">--</h6>
                    </div>
                    <div class="col-lg-6 mb-3">
...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-header d-flex align-items-center">
                <h5 class="card-title mb-0">Customer Inquiry Item</h5>
                <?php
                    echo $writeAccess['total'] > 0 && $publishStatus == 'No' ? '<div class="card-actions cursor-pointer ms-auto d-flex button-group">
                                                            <button class="btn btn-success mb-0 px-4" data-bs-toggle="modal" data-bs-target="#customer-inquiry-item-modal" id="add-customer-inquiry-item">Create</button>
                                                        </div>' : '';
                ?>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table id="customer-inquiry-item-table" class="table align-middle text-nowrap w-100 mb-0">
                        <thead class="text-dark">
                            <tr>
                                <th>Customer Inquiry Item</th>
...
<div id="customer-inquiry-item-modal" class="modal fade" tabindex="-1" aria-labelledby="customer-inquiry-item-modal" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable modal-r">
        <div class="modal-content">
            <div class="modal-header border-bottom">
                <h5 class="modal-title fw-8" id="customer-inquiry-item-title"></h5>
                <button type="button" class="btn-close fs-2" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form id="customer-inquiry-item-form" method="post" action="#">
                    <input type="hidden" id="customer_inquiry_item_id" name="customer_inquiry_item_id">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="mb-3">
                                <label class="form-label" for="customer_inquiry_title">Title <span class="text-danger">*</span></label>
                                <input type="text" class="form-control maxlength" id="customer_inquiry_title" name="customer_inquiry_title" maxlength="500" autocomplete="off">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <label class="form-label" for="customer_inquiry_heading">Heading <span class="text-danger">*</span></label>
                            <div class="mb-3">
                            <input type="text" class="form-control maxlength" id="customer_inquiry_heading" name="customer_inquiry_heading" maxlength="500" autocomplete="off">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="mb-3">
                                <label class="form-label" for="customer_inquiry_paragraph">Paragraph <span class="text-danger">*</span></label>
                                <textarea class="form-control maxlength" id="customer_inquiry_paragraph" name="customer_inquiry_paragraph" maxlength="5000" rows="5"></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="mb-3">
                                <label class="form-label" for="customer_inquiry_image">Customer Inquiry Image</label>
                                <input type="file" class="form-control" id="customer_inquiry_image" name="customer_inquiry_image">
                            </div>
                        </div>
                    </div>
                    <div class="row">
            ...
            <div class="modal-footer border-top">
                <button type="button" class="btn btn-outline-danger" data-bs-dismiss="modal">Close</button>
                <button type="submit" form="customer-inquiry-item-form" class="btn btn-success" id="submit-customer-inquiry-item-data">Save changes</button>
            </div>
        </div>
    </div>
</div>
