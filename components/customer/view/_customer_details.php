            ...
            <div class="card-header d-flex align-items-center">
                ...
                <?php
                    echo $writeAccess['total'] > 0 ? '<div class="card-actions ms-auto d-flex button-group">
                                                            <a href="javascript:void(0)" class="link text-dark fw-medium py-1 px-2 ms-auto" data-bs-toggle="modal" data-bs-target="#about-modal" id="edit-about-details"><i class="ti ti-pencil fs-6"></i></a>
                                                        </div>' : '';
                ?>
            </div>
            <hr class="m-0" />
    ...
    <div class="col-lg-4">
        ...
        <div class="card">
            <div class="card-header d-flex align-items-center">
                ...
                <?php
                    echo $writeAccess['total'] > 0 ? '<div class="card-actions ms-auto d-flex button-group">
                                                            <a href="javascript:void(0)" class="link text-dark fw-medium py-1 px-2 ms-auto" data-bs-toggle="modal" data-bs-target="#private-information-modal" id="edit-private-information-details"><i class="ti ti-pencil fs-6"></i></a>
                                                        </div>' : '';
                ?>
            </div>
            <hr class="m-0" />
