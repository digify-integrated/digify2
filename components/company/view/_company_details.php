            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-6 mb-3">
                        ...
                        <h6 class="fw-semibold mb-0" id="company_name_summary">--</h6>
                    </div>
                    <div class="col-lg-6 mb-3">
                        <p class="mb-1 fs-2">Legal Name</p>
                        <h6 class="fw-semibold mb-0" id="legal_name_summary">--</h6>
                    </div>
                    <div class="col-lg-6 mb-3">
                    ...
                    <div class="col-lg-6 mb-3">
                        <p class="mb-1 fs-2">Currency</p>
                        <h6 class="fw-semibold mb-0" id="currency_name_summary">--</h6>
                    </div>
                    <div class="col-lg-6 mb-3">
                        <p class="mb-1 fs-2">Tax ID</p>
                        <h6 class="fw-semibold mb-0" id="tax_id_summary">--</h6>
                    </div>
                    <div class="col-lg-6 mb-3">
                    ...
                    <div class="col-lg-6 mb-3">
                        <p class="mb-1 fs-2">Website</p>
                        <h6 class="fw-semibold mb-0" id="website_summary">--</h6>
                    </div>
                </div>
            </div>
        </div>
