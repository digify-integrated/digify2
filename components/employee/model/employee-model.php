...
class EmployeeModel {
    ...
    #
    # -------------------------------------------------------------
    public function updateEmployeeAddress($p_employee_address_id, $p_employee_id, $p_address_type_id, $p_address_type_name, $p_address, $p_city_id, $p_city_name, $p_state_id, $p_state_name, $p_country_id, $p_country_name, $p_telephone, $p_mobile, $p_email, $p_last_log_by) {
        $stmt = $this->db->getConnection()->prepare('CALL updateEmployeeAddress(:p_employee_address_id, :p_employee_id, :p_address_type_id, :p_address_type_name, :p_address, :p_city_id, :p_city_name, :p_state_id, :p_state_name, :p_country_id, :p_country_name, :p_telephone, :p_mobile, :p_email, :p_last_log_by)');
    ...
    # Description: Updates the employee address to default.
    #
    # Parameters:
    # - $p_employee_address_id (int): The employee ID.
    # - $p_employee_id (int): The employee ID.
    # - $p_last_log_by (int): The last logged user.
    #
    # Returns: None
    #
    # -------------------------------------------------------------
    public function updateEmployeeAddressDefault($p_employee_address_id, $p_employee_id, $p_last_log_by) {
        $stmt = $this->db->getConnection()->prepare('CALL updateEmployeeAddressDefault(:p_employee_address_id, :p_employee_id, :p_last_log_by)');
        $stmt->bindValue(':p_employee_address_id', $p_employee_address_id, PDO::PARAM_INT);
        $stmt->bindValue(':p_employee_id', $p_employee_id, PDO::PARAM_INT);
        $stmt->bindValue(':p_last_log_by', $p_last_log_by, PDO::PARAM_INT);
        $stmt->execute();
    ...
    #
    # -------------------------------------------------------------
    public function insertEmployeeAddress($p_employee_id, $p_address_type_id, $p_address_type_name, $p_address, $p_city_id, $p_city_name, $p_state_id, $p_state_name, $p_country_id, $p_country_name, $p_telephone, $p_mobile, $p_email, $p_last_log_by) {
        $stmt = $this->db->getConnection()->prepare('CALL insertEmployeeAddress(:p_employee_id, :p_address_type_id, :p_address_type_name, :p_address, :p_city_id, :p_city_name, :p_state_id, :p_state_name, :p_country_id, :p_country_name, :p_telephone, :p_mobile, :p_email, :p_last_log_by)');
        $stmt->bindValue(':p_employee_id', $p_employee_id, PDO::PARAM_INT);
        $stmt->bindValue(':p_address_type_id', $p_address_type_id, PDO::PARAM_INT);
        $stmt->bindValue(':p_address_type_name', $p_address_type_name, PDO::PARAM_STR);
        $stmt->bindValue(':p_address', $p_address, PDO::PARAM_STR);
