...
class ReligionController {
    ...
    # Description: 
    # The constructor initializes the object with the provided ReligionModel, AuthenticationModel and SecurityModel instances.
    ...
    public function addReligion() {
        ...
        if (isset($_POST['religion_name']) && !empty($_POST['religion_name'])) {
            $userID = $_SESSION['user_account_id'];
            $religionName = $_POST['religion_name'];
            ...
            $response = [
                ...
                'title' => 'Insert Religion Success',
                'message' => 'The religion has been inserted successfully.',
                'messageType' => 'success'
            ];
    ...
    # Description: 
    # Updates the religion if it exists; otherwise, return an error message.
    #
    # Parameters: None
    #
    # Returns: Array
    ...
    public function updateReligion() {
        ...
        if (isset($_POST['religion_id']) && !empty($_POST['religion_id']) && isset($_POST['religion_name']) && !empty($_POST['religion_name'])) {
            $userID = $_SESSION['user_account_id'];
            ...
            $response = [
                'success' => true,
                'title' => 'Update Religion Success',
                'message' => 'The religion has been updated successfully.',
                'messageType' => 'success'
            ];
    ...
    # Description: 
    # Delete the selected religion if it exists; otherwise, skip it.
    #
    # Parameters: None
    #
    # Returns: Array
    ...
    public function deleteMultipleReligion() {
        ...
        if (isset($_POST['religion_id']) && !empty($_POST['religion_id'])) {
            ...
            $response = [
                'success' => true,
                'title' => 'Delete Multiple Religions Success',
    ...
    # Description: 
    # Handles the retrieval of religion details.
    #
    # Parameters: None
    #
    # Returns: Array
        ...
        if (isset($_POST['religion_id']) && !empty($_POST['religion_id'])) {
            ...
            if($total === 0){
                $response = [
                    'success' => false,
                    'notExist' => true,
                    'title' => 'Get Religion Details Error',
                    'message' => 'The religion does not exist.',
                    'messageType' => 'error'
                ];
...
$controller = new ReligionController(new ReligionModel(new DatabaseModel), new AuthenticationModel(new DatabaseModel), new SecurityModel(), new SystemModel());
