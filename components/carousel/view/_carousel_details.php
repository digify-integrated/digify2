                ...
                <div class="card-actions cursor-pointer ms-auto d-flex button-group">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        <?php
                           ...
                           echo $deleteAccess['total'] > 0 ? '<li><button class="dropdown-item" type="button" id="delete-carousel">Delete Carousel</button></li>' : '';
                        ?>
                    </ul>
                </div>
                <?php
                    echo $writeAccess['total'] > 0 ? '<div class="card-actions cursor-pointer ms-auto d-flex button-group">
                                                            <button class="btn btn-info mb-0 px-4" data-bs-toggle="modal" id="edit-details" data-bs-target="#carousel-modal">Edit</button>
                                                        </div>' : '';
                ?>
            </div>
            <div class="card-body">
...
<div class="modal fade" id="carousel-modal" tabindex="-1" aria-labelledby="carousel-modal" aria-hidden="true">
