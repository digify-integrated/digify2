                ...
                <?php
                    echo $deleteAccess['total'] > 0 ? '<button type="button" class="btn btn-dark dropdown-toggle action-dropdown mb-0 d-none" data-bs-toggle="dropdown" aria-expanded="false">Action</button>
                                                        <ul class="dropdown-menu dropdown-menu-end">
                                                            <li><button class="dropdown-item" type="button" id="delete-work-locations">Delete Work Locations</button></li>
                                                        </ul>' : '';
            ...
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="work-locations-table" class="table align-middle text-nowrap w-100 mb-4">
...
<div class="offcanvas offcanvas-start" tabindex="-1" id="filter-offcanvas" aria-labelledby="filter-offcanvas-label">
    ...
    <div class="offcanvas-body p-0">
        <div class="border-bottom rounded-0">
            <h6 class="mt-4 mb-3 mx-4 fw-semibold">By City</h6>
            <div class="pb-4 px-4" id="city-filter">
                <select id="city_filter" name="city_filter" class="select2 form-control"></select>
            </div>
        </div>
        <div class="border-bottom rounded-0">
            <h6 class="mt-4 mb-3 mx-4 fw-semibold">By State</h6>
            <div class="pb-4 px-4" id="state-filter">
                <select id="state_filter" name="state_filter" class="select2 form-control"></select>
            </div>
        </div>
        <div class="border-bottom rounded-0">
            <h6 class="mt-4 mb-3 mx-4 fw-semibold">By Country</h6>
            <div class="pb-4 px-4" id="country-filter">
                <select id="country_filter" name="country_filter" class="select2 form-control"></select>
            </div>
        </div>
        <div class="p-4">
