...
class SecuritySettingModel {
    ...
    # - $p_password_recovery_link (string): The value of the setting.
    # - $p_last_log_by (int): The last logged user.
    #
    # Returns: None
    #
    # -------------------------------------------------------------
    public function updateSecuritySetting($p_max_failed_login, $p_max_failed_otp_attempt, $p_security_setting_description, $p_otp_duration, $p_reset_password_token_duration, $p_session_inactivity_limit, $p_password_recovery_link, $p_last_log_by) {
        $stmt = $this->db->getConnection()->prepare('CALL updateSecuritySetting(:p_max_failed_login, :p_max_failed_otp_attempt, :p_security_setting_description, :p_otp_duration, :p_reset_password_token_duration, :p_session_inactivity_limit, :p_password_recovery_link, :p_last_log_by)');
