...
CREATE PROCEDURE updateSecuritySetting(IN p_max_failed_login INT, IN p_max_failed_otp_attempt INT, IN p_password_expiry_duration INT, IN p_otp_duration INT, IN p_reset_password_token_duration INT, IN p_session_inactivity_limit INT, IN p_password_recovery_link VARCHAR(1000), IN p_registration_verification_token_duration INT, IN p_last_log_by INT)
BEGIN
