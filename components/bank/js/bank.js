(function($) {
    ...
    $(function() {
        ...
        $(document).on('click','#delete-bank',function() {
            ...
            if(bank_id.length > 0){
                Swal.fire({
                    title: 'Confirm Multiple Bank Deletion',
                    text: 'Are you sure you want to delete these bank?',
                    icon: 'warning',
                    showCancelButton: !0,
                    confirmButtonText: 'Delete',
                    cancelButtonText: 'Cancel',
                ...
                showNotification('Deletion Multiple Banks Error', 'Please select the bank you wish to delete.', 'danger');
            }
        });
...
function bankTable(datatable_name, buttons = false, show_all = false){
    toggleHideActionDropdown();
