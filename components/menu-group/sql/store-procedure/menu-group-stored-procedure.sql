...
CREATE PROCEDURE insertMenuGroup(IN p_menu_group_name VARCHAR(100), IN p_app_module_id INT, IN p_app_module_name VARCHAR(100), IN p_order_sequence TINYINT(10), IN p_last_log_by INT, OUT p_menu_group_id INT)
BEGIN
...
CREATE PROCEDURE updateMenuGroup(IN p_menu_group_id INT, IN p_menu_group_name VARCHAR(100), IN p_app_module_id INT, IN p_app_module_name VARCHAR(100), IN p_order_sequence TINYINT(10), IN p_last_log_by INT)
BEGIN
