    ...
    $(function() {
        ...
        $(document).on('click','#delete-language-proficiency',function() {
            ...
            if(language_proficiency_id.length > 0){
                Swal.fire({
                    title: 'Confirm Multiple Language Proficiency Deletion',
                    text: 'Are you sure you want to delete these language proficiency?',
                    icon: 'warning',
                    showCancelButton: !0,
                    confirmButtonText: 'Delete',
                    cancelButtonText: 'Cancel',
                ...
                showNotification('Deletion Multiple Language Proficiencys Error', 'Please select the language proficiency you wish to delete.', 'danger');
            }
        });
