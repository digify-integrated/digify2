                ...
                <?php
                    echo $deleteAccess['total'] > 0 ? '<button type="button" class="btn btn-dark dropdown-toggle action-dropdown mb-0 d-none" data-bs-toggle="dropdown" aria-expanded="false">Action</button>
                                                        <ul class="dropdown-menu dropdown-menu-end">
                                                            <li><button class="dropdown-item" type="button" id="delete-language-proficiency">Delete Language Proficiency</button></li>
                                                        </ul>' : '';
            ...
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="language-proficiency-table" class="table search-table align-middle text-nowrap w-100 mb-4">
