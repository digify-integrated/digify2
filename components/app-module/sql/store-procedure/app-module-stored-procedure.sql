...
CREATE PROCEDURE insertAppModule(IN p_app_module_name VARCHAR(100), IN p_app_module_description VARCHAR(500), IN p_redirect_link VARCHAR(50), IN p_order_sequence TINYINT(10), IN p_last_log_by INT, OUT p_app_module_id INT)
BEGIN
...
CREATE PROCEDURE updateAppModule(IN p_app_module_id INT, IN p_app_module_name VARCHAR(100), IN p_app_module_description VARCHAR(500), IN p_redirect_link VARCHAR(50), IN p_order_sequence TINYINT(10), IN p_last_log_by INT)
BEGIN
