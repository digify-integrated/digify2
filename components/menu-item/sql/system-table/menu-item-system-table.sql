...
INSERT INTO menu_item (menu_item_name, menu_item_url, app_module_id, app_module_name, parent_id, parent_name, order_sequence, last_log_by) VALUES ('General Settings', 'general-settings.php', 1, 'Settings', '', '', 21, '1');
