...
<body>
            ...
            <div class="body-wrapper">
                <div class="container-fluid">
                    <?php 
                        ...
                        if($newRecord){
                            require_once('components/religion/view/_religion_new.php');
                        }
                        else if(!empty($detailID)){
                            require_once('components/religion/view/_religion_details.php');
                        }
                        else{
                            require_once('components/religion/view/_religion.php');
                        }
                    ?>
                </div>
    ...
    <?php
        $scriptLink = 'religion.js';

        if($newRecord){
            $scriptLink = 'religion-new.js';
        }
        else if(!empty($detailID)){
            $scriptLink = 'religion-details.js';
        }

        echo '<script src="./components/religion/js/'. $scriptLink .'?v=' . rand() .'"></script>';
    ?>
</body>
