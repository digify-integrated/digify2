...
<body>
            ...
            <div class="body-wrapper">
                <div class="container-fluid">
                    <?php 
                        ...
                        if($newRecord){
                            require_once('components/process-step/view/_process_step_new.php');
                        }
                        else if(!empty($detailID)){
                            require_once('components/process-step/view/_process_step_details.php');
                        }
                        else{
                            require_once('components/process-step/view/_process_step.php');
                        }
                    ?>
                </div>
    ...
    <?php
        $scriptLink = 'process-step.js';

        if($newRecord){
            $scriptLink = 'process-step-new.js';
        }
        else if(!empty($detailID)){
            $scriptLink = 'process-step-details.js';
        }

        echo '<script src="./components/process-step/js/'. $scriptLink .'?v=' . rand() .'"></script>';
    ?>
</body>
