...
<body>
            ...
            <div class="body-wrapper">
                <div class="container-fluid">
                    <?php 
                        ...
                        if($newRecord){
                            require_once('components/accordion/view/_accordion_new.php');
                        }
                        else if(!empty($detailID)){
                            require_once('components/accordion/view/_accordion_details.php');
                        }
                        else{
                            require_once('components/accordion/view/_accordion.php');
                        }
                    ?>
                </div>
    ...
    <?php
        $scriptLink = 'accordion.js';

        if($newRecord){
            $scriptLink = 'accordion-new.js';
        }
        else if(!empty($detailID)){
            $scriptLink = 'accordion-details.js';
        }

        echo '<script src="./components/accordion/js/'. $scriptLink .'?v=' . rand() .'"></script>';
    ?>
</body>
