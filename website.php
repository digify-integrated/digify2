...
<body>
            ...
            <div class="body-wrapper">
                <div class="container-fluid">
                    <?php 
                        ...
                        if($newRecord){
                            require_once('components/website/view/_website_new.php');
                        }
                        else if(!empty($detailID)){
                            require_once('components/website/view/_website_details.php');
                        }
                        else{
                            require_once('components/website/view/_website.php');
                        }
                    ?>
                </div>
    ...
    <?php
        $scriptLink = 'website.js';

        if($newRecord){
            $scriptLink = 'website-new.js';
        }
        else if(!empty($detailID)){
            $scriptLink = 'website-details.js';
        }

        echo '<script src="./components/website/js/'. $scriptLink .'?v=' . rand() .'"></script>';
    ?>
</body>
