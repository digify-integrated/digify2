...
<body>
            ...
            <div class="body-wrapper">
                <div class="container-fluid">
                    <?php 
                        ...
                        if($newRecord){
                            require_once('components/call-to-action/view/_call_to_action_new.php');
                        }
                        else if(!empty($detailID)){
                            require_once('components/call-to-action/view/_call_to_action_details.php');
                        }
                        else{
                            require_once('components/call-to-action/view/_call_to_action.php');
                        }
                    ?>
                </div>
    ...
    <?php
        $scriptLink = 'call-to-action.js';

        if($newRecord){
            $scriptLink = 'call-to-action-new.js';
        }
        else if(!empty($detailID)){
            $scriptLink = 'call-to-action-details.js';
        }

        echo '<script src="./components/call-to-action/js/'. $scriptLink .'?v=' . rand() .'"></script>';
    ?>
</body>
