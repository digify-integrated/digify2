...
<body>
            ...
            <div class="body-wrapper">
                <div class="container-fluid">
                    <?php 
                        ...
                        if($newRecord){
                            require_once('components/bank-account-type/view/_bank_account_type_new.php');
                        }
                        else if(!empty($detailID)){
                            require_once('components/bank-account-type/view/_bank_account_type_details.php');
                        }
                        else{
                            require_once('components/bank-account-type/view/_bank_account_type.php');
                        }
                    ?>
                </div>
    ...
    <?php
        $scriptLink = 'bank-account-type.js';

        if($newRecord){
            $scriptLink = 'bank-account-type-new.js';
        }
        else if(!empty($detailID)){
            $scriptLink = 'bank-account-type-details.js';
        }

        echo '<script src="./components/bank-account-type/js/'. $scriptLink .'?v=' . rand() .'"></script>';
    ?>
</body>
