...
<body>
            ...
            <div class="body-wrapper">
                <div class="container-fluid">
                    <?php 
                        ...
                        if($newRecord){
                            require_once('components/header/view/_header_new.php');
                        }
                        else if(!empty($detailID)){
                            require_once('components/header/view/_header_details.php');
                        }
                        else{
                            require_once('components/header/view/_header.php');
                        }
                    ?>
                </div>
    ...
    <?php
        $scriptLink = 'header.js';

        if($newRecord){
            $scriptLink = 'header-new.js';
        }
        else if(!empty($detailID)){
            $scriptLink = 'header-details.js';
        }

        echo '<script src="./components/header/js/'. $scriptLink .'?v=' . rand() .'"></script>';
    ?>
</body>
