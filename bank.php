...
<body>
            ...
            <div class="body-wrapper">
                <div class="container-fluid">
                    <?php 
                        ...
                        if($newRecord){
                            require_once('components/bank/view/_bank_new.php');
                        }
                        else if(!empty($detailID)){
                            require_once('components/bank/view/_bank_details.php');
                        }
                        else{
                            require_once('components/bank/view/_bank.php');
                        }
                    ?>
                </div>
    ...
    <?php
        ...
        if($newRecord){
            $scriptLink = 'bank-new.js';
        }
        else if(!empty($detailID)){
            $scriptLink = 'bank-details.js';
        }

        echo '<script src="./components/bank/js/'. $scriptLink .'?v=' . rand() .'"></script>';
    ?>
</body>
