...
<body>
            ...
            <div class="body-wrapper">
                <div class="container-fluid">
                    <?php 
                        ...
                        if($newRecord){
                            require_once('components/relation/view/_relation_new.php');
                        }
                        else if(!empty($detailID)){
                            require_once('components/relation/view/_relation_details.php');
                        }
                        else{
                            require_once('components/relation/view/_relation.php');
                        }
                    ?>
                </div>
    ...
    <?php
        $scriptLink = 'relation.js';

        if($newRecord){
            $scriptLink = 'relation-new.js';
        }
        else if(!empty($detailID)){
            $scriptLink = 'relation-details.js';
        }

        echo '<script src="./components/relation/js/'. $scriptLink .'?v=' . rand() .'"></script>';
    ?>
</body>
