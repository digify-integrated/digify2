...
<body>
            ...
            <div class="body-wrapper">
                <div class="container-fluid">
                    <?php 
                        ...
                        if($newRecord){
                            require_once('components/footer/view/_footer_new.php');
                        }
                        else if(!empty($detailID)){
                            require_once('components/footer/view/_footer_details.php');
                        }
                        else{
                            require_once('components/footer/view/_footer.php');
                        }
                    ?>
                </div>
    ...
    <?php
        $scriptLink = 'footer.js';

        if($newRecord){
            $scriptLink = 'footer-new.js';
        }
        else if(!empty($detailID)){
            $scriptLink = 'footer-details.js';
        }

        echo '<script src="./components/footer/js/'. $scriptLink .'?v=' . rand() .'"></script>';
    ?>
</body>
