...
<body>
            ...
            <div class="body-wrapper">
                <div class="container-fluid">
                    <?php 
                        ...
                        if($newRecord){
                            require_once('components/employment-types/view/_employment_types_new.php');
                        }
                        else if(!empty($detailID)){
                            require_once('components/employment-types/view/_employment_types_details.php');
                        }
                        else{
                            require_once('components/employment-types/view/_employment_types.php');
                        }
                    ?>
                </div>
    ...
    <?php
        $scriptLink = 'employment-types.js';

        if($newRecord){
            $scriptLink = 'employment-types-new.js';
        }
        else if(!empty($detailID)){
            $scriptLink = 'employment-types-details.js';
        }

        echo '<script src="./components/employment-types/js/'. $scriptLink .'?v=' . rand() .'"></script>';
    ?>
</body>
