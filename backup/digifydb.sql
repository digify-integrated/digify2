...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 04, 2024 at 03:29 PM
...
(14460, 'user_account', 2, 'Last Connection Date: 2024-09-04 08:38:00 -> 2024-09-04 19:51:53<br/>', 2, '2024-09-04 19:51:53', '2024-09-04 19:51:53'),
(14461, 'role_permission', 80, 'Menu Item: Vouchers -> Voucher<br/>', 2, '2024-09-04 19:57:06', '2024-09-04 19:57:06'),
(14462, 'menu_item', 75, 'Menu Item Name: Vouchers -> Voucher<br/>Menu Item URL: vouchers.php -> voucher.php<br/>', 2, '2024-09-04 19:57:06', '2024-09-04 19:57:06'),
(14463, 'voucher', 1, 'Voucher created. <br/><br/>Voucher Name: asdas<br/>Description: dasdas<br/>Voucher Usage Start Date: 2024-09-04<br/>Voucher Usage End Date: 2024-09-04<br/>Discount Type: By Percentage<br/>Discount Amount: 12<br/>Minimum Booking Amount: 12<br/>Voucher Quantity: 12<br/>Available Voucher: 12', 2, '2024-09-04 21:16:44', '2024-09-04 21:16:44'),
(14464, 'voucher', 1, 'Voucher Usage End Date: 2024-09-04 -> 2024-09-11<br/>', 2, '2024-09-04 21:21:39', '2024-09-04 21:21:39'),
(14465, 'voucher', 1, 'Voucher Name: asdas -> dfgfg<br/>Voucher Code: dasdas -> dasdasdfdfg<br/>Voucher Usage Start Date: 2024-09-04 -> 2024-09-02<br/>Voucher Usage End Date: 2024-09-11 -> 2024-09-06<br/>Discount Type: By Percentage -> Fix Amount<br/>Discount Amount: 12 -> 90<br/>Minimum Booking Amount: 12 -> 90<br/>Voucher Quantity: 12 -> 90<br/>Available Voucher: 12 -> 90<br/>', 2, '2024-09-04 21:22:51', '2024-09-04 21:22:51'),
(14466, 'voucher', 2, 'Voucher created. <br/><br/>Voucher Name: sad<br/>Description: asd<br/>Voucher Usage Start Date: 2024-09-03<br/>Voucher Usage End Date: 2024-09-18<br/>Discount Type: By Percentage<br/>Discount Amount: 12<br/>Minimum Booking Amount: 12<br/>Voucher Quantity: 12<br/>Available Voucher: 12', 2, '2024-09-04 21:27:01', '2024-09-04 21:27:01');
...
DROP TABLE IF EXISTS `client_container`;
CREATE TABLE `client_container` (
  `client_container_id` int(10) UNSIGNED NOT NULL,
  `client_style_id` int(10) UNSIGNED NOT NULL,
  `client_container` longtext NOT NULL,
  `created_date` datetime NOT NULL DEFAULT current_timestamp(),
  `last_log_by` int(10) UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Triggers `client_container`
--
DROP TRIGGER IF EXISTS `client_container_trigger_insert`;
DELIMITER $$
CREATE TRIGGER `client_container_trigger_insert` AFTER INSERT ON `client_container` FOR EACH ROW BEGIN
    DECLARE audit_log TEXT DEFAULT 'Client container created. <br/>';

    IF NEW.client_container <> '' THEN
        SET audit_log = CONCAT(audit_log, "<br/>Client Container: ", NEW.client_container);
    END IF;

    INSERT INTO audit_log (table_name, reference_id, log, changed_by, changed_at) 
    VALUES ('client_container', NEW.client_container_id, audit_log, NEW.last_log_by, NOW());
END
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `client_container_trigger_update`;
DELIMITER $$
CREATE TRIGGER `client_container_trigger_update` AFTER UPDATE ON `client_container` FOR EACH ROW BEGIN
    DECLARE audit_log TEXT DEFAULT '';

    IF NEW.client_container <> OLD.client_container THEN
        SET audit_log = CONCAT(audit_log, "Client Container: ", OLD.client_container, " -> ", NEW.client_container, "<br/>");
    END IF;
...
CREATE TABLE `client_style` (
  `client_style_id` int(10) UNSIGNED NOT NULL,
  `client_style_name` varchar(100) NOT NULL,
  `description` varchar(500) DEFAULT NULL,
  `created_date` datetime NOT NULL DEFAULT current_timestamp(),
  `last_log_by` int(10) UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Triggers `client_style`
--
DROP TRIGGER IF EXISTS `client_style_trigger_insert`;
DELIMITER $$
CREATE TRIGGER `client_style_trigger_insert` AFTER INSERT ON `client_style` FOR EACH ROW BEGIN
    DECLARE audit_log TEXT DEFAULT 'Client style created. <br/>';

    IF NEW.client_style_name <> '' THEN
        SET audit_log = CONCAT(audit_log, "<br/>Client Style Name: ", NEW.client_style_name);
    END IF;
    ...
    INSERT INTO audit_log (table_name, reference_id, log, changed_by, changed_at) 
    VALUES ('client_style', NEW.client_style_id, audit_log, NEW.last_log_by, NOW());
END
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `client_style_trigger_update`;
DELIMITER $$
CREATE TRIGGER `client_style_trigger_update` AFTER UPDATE ON `client_style` FOR EACH ROW BEGIN
    DECLARE audit_log TEXT DEFAULT '';

    IF NEW.client_style_name <> OLD.client_style_name THEN
        SET audit_log = CONCAT(audit_log, "Client Style Name: ", OLD.client_style_name, " -> ", NEW.client_style_name, "<br/>");
    END IF;
...
(2, 'Administrator', 'lawrenceagulto.317@gmail.com', 'ldagulto', 'RYHObc8sNwIxdPDNJwCsO8bXKZJXYx7RjTgEWMC17FY%3D', './components/user-account/image/profile_image/2/tQag.png', 'No', 'Yes', NULL, 0, '2024-09-04 19:51:53', '2025-12-30', NULL, NULL, 'Yes', 'No', NULL, NULL, 0, NULL, 0, NULL, 'Yes', '5%2FbcqNI3wAzs5By007y5I6fYDl8B33DrfJVVl8%2FvlO4%3D', 'Customer', 'Yes', 1, NULL, NULL, NULL, NULL, '2024-08-21 09:45:47', 2),
...
ALTER TABLE `client_container`
  ADD PRIMARY KEY (`client_container_id`),
  ADD KEY `last_log_by` (`last_log_by`),
  ADD KEY `client_container_index_client_container_id` (`client_container_id`),
  ADD KEY `client_container_index_client_style_id` (`client_style_id`);
...
--
ALTER TABLE `client_style`
  ADD PRIMARY KEY (`client_style_id`),
  ADD KEY `last_log_by` (`last_log_by`),
  ADD KEY `client_style_index_client_style_id` (`client_style_id`);
...
--
ALTER TABLE `audit_log`
  MODIFY `audit_log_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14467;
...
--
ALTER TABLE `client_container`
  MODIFY `client_container_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `client_style`
  MODIFY `client_style_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `customer_inquiry`
  MODIFY `customer_inquiry_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
