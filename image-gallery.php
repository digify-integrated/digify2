...
<body>
            ...
            <div class="body-wrapper">
                <div class="container-fluid">
                    <?php 
                        ...
                        if($newRecord){
                            require_once('components/image-gallery/view/_image_gallery_new.php');
                        }
                        else if(!empty($detailID)){
                            require_once('components/image-gallery/view/_image_gallery_details.php');
                        }
                        else{
                            require_once('components/image-gallery/view/_image_gallery.php');
                        }
                    ?>
                </div>
    ...
    <?php
        $scriptLink = 'image-gallery.js';

        if($newRecord){
            $scriptLink = 'image-gallery-new.js';
        }
        else if(!empty($detailID)){
            $scriptLink = 'image-gallery-details.js';
        }

        echo '<script src="./components/image-gallery/js/'. $scriptLink .'?v=' . rand() .'"></script>';
    ?>
</body>
