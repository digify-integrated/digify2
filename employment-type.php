...
<body>
            ...
            <div class="body-wrapper">
                <div class="container-fluid">
                    <?php 
                        ...
                        if($newRecord){
                            require_once('components/employment-type/view/_employment_type_new.php');
                        }
                        else if(!empty($detailID)){
                            require_once('components/employment-type/view/_employment_type_details.php');
                        }
                        else{
                            require_once('components/employment-type/view/_employment_type.php');
                        }
                    ?>
                </div>
    ...
    <?php
        $scriptLink = 'employment-type.js';

        if($newRecord){
            $scriptLink = 'employment-type-new.js';
        }
        else if(!empty($detailID)){
            $scriptLink = 'employment-type-details.js';
        }

        echo '<script src="./components/employment-type/js/'. $scriptLink .'?v=' . rand() .'"></script>';
    ?>
</body>
