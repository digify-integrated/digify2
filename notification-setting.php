...
<body>
            ...
            <div class="body-wrapper">
                <div class="container-fluid">
                    <?php 
                        ...
                        if($newRecord){
                            require_once('components/notification-setting/view/_notification_setting_new.php');
                        }
                        else if(!empty($detailID)){
                            require_once('components/notification-setting/view/_notification_setting_details.php');
                        }
                        else{
                            require_once('components/notification-setting/view/_notification_setting.php');
                        }
                    ?>
                </div>
    ...
    <?php
        $scriptLink = 'notification-setting.js';

        if($newRecord){
            $scriptLink = 'notification-setting-new.js';
        }
        else if(!empty($detailID)){
            $scriptLink = 'notification-setting-details.js';
        }

        echo '<script src="./components/notification-setting/js/'. $scriptLink .'?v=' . rand() .'"></script>';
    ?>
</body>
