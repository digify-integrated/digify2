...
<body>
            ...
            <div class="body-wrapper">
                <div class="container-fluid">
                    <?php 
                        ...
                        if($newRecord){
                            require_once('components/testimonial/view/_testimonial_new.php');
                        }
                        else if(!empty($detailID)){
                            require_once('components/testimonial/view/_testimonial_details.php');
                        }
                        else{
                            require_once('components/testimonial/view/_testimonial.php');
                        }
                    ?>
                </div>
    ...
    <?php
        $scriptLink = 'testimonial.js';

        if($newRecord){
            $scriptLink = 'testimonial-new.js';
        }
        else if(!empty($detailID)){
            $scriptLink = 'testimonial-details.js';
        }

        echo '<script src="./components/testimonial/js/'. $scriptLink .'?v=' . rand() .'"></script>';
    ?>
</body>
