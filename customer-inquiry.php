...
<body>
            ...
            <div class="body-wrapper">
                <div class="container-fluid">
                    <?php 
                        ...
                        if($newRecord){
                            require_once('components/customer-inquiry/view/_customer_inquiry_new.php');
                        }
                        else if(!empty($detailID)){
                            require_once('components/customer-inquiry/view/_customer_inquiry_details.php');
                        }
                        else{
                            require_once('components/customer-inquiry/view/_customer_inquiry.php');
                        }
                    ?>
                </div>
    ...
    <?php
        $scriptLink = 'customer-inquiry.js';

        if($newRecord){
            $scriptLink = 'customer-inquiry-new.js';
        }
        else if(!empty($detailID)){
            $scriptLink = 'customer-inquiry-details.js';
        }

        echo '<script src="./components/customer-inquiry/js/'. $scriptLink .'?v=' . rand() .'"></script>';
    ?>
</body>
