...
<body>
            ...
            <div class="body-wrapper">
                <div class="container-fluid">
                    <?php 
                        ...
                        if($newRecord){
                            require_once('components/voucher/view/_voucher_new.php');
                        }
                        else if(!empty($detailID)){
                            require_once('components/voucher/view/_voucher_details.php');
                        }
                        else{
                            require_once('components/voucher/view/_voucher.php');
                        }
                    ?>
                </div>
    ...
    <?php
        $scriptLink = 'voucher.js';

        if($newRecord){
            $scriptLink = 'voucher-new.js';
        }
        else if(!empty($detailID)){
            $scriptLink = 'voucher-details.js';
        }

        echo '<script src="./components/voucher/js/'. $scriptLink .'?v=' . rand() .'"></script>';
    ?>
</body>
