...
<body>
            ...
            <div class="body-wrapper">
                <div class="container-fluid">
                    <?php 
                        ...
                        if($newRecord){
                            require_once('components/contact-form/view/_contact_form_new.php');
                        }
                        else if(!empty($detailID)){
                            require_once('components/contact-form/view/_contact_form_details.php');
                        }
                        else{
                            require_once('components/contact-form/view/_contact_form.php');
                        }
                    ?>
                </div>
    ...
    <?php
        $scriptLink = 'contact-form.js';

        if($newRecord){
            $scriptLink = 'contact-form-new.js';
        }
        else if(!empty($detailID)){
            $scriptLink = 'contact-form-details.js';
        }

        echo '<script src="./components/contact-form/js/'. $scriptLink .'?v=' . rand() .'"></script>';
    ?>
</body>
