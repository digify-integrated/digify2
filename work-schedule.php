...
<body>
            ...
            <div class="body-wrapper">
                <div class="container-fluid">
                    <?php 
                        ...
                        if($newRecord){
                            require_once('components/work-schedule/view/_work_schedule_new.php');
                        }
                        else if(!empty($detailID)){
                            require_once('components/work-schedule/view/_work_schedule_details.php');
                        }
                        else{
                            require_once('components/work-schedule/view/_work_schedule.php');
                        }
                    ?>
                </div>
    ...
    <?php
        $scriptLink = 'work-schedule.js';

        if($newRecord){
            $scriptLink = 'work-schedule-new.js';
        }
        else if(!empty($detailID)){
            $scriptLink = 'work-schedule-details.js';
        }

        echo '<script src="./components/work-schedule/js/'. $scriptLink .'?v=' . rand() .'"></script>';
    ?>
</body>
