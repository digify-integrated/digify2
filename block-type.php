...
<body>
            ...
            <div class="body-wrapper">
                <div class="container-fluid">
                    <?php 
                        ...
                        if($newRecord){
                            require_once('components/block-type/view/_block_type_new.php');
                        }
                        else if(!empty($detailID)){
                            require_once('components/block-type/view/_block_type_details.php');
                        }
                        else{
                            require_once('components/block-type/view/_block_type.php');
                        }
                    ?>
                </div>
    ...
    <?php
        $scriptLink = 'block-type.js';

        if($newRecord){
            $scriptLink = 'block-type-new.js';
        }
        else if(!empty($detailID)){
            $scriptLink = 'block-type-details.js';
        }

        echo '<script src="./components/block-type/js/'. $scriptLink .'?v=' . rand() .'"></script>';
    ?>
</body>
