...
<body>
            ...
            <div class="body-wrapper">
                <div class="container-fluid">
                    <?php 
                        ...
                        if($newRecord){
                            require_once('components/company/view/_company_new.php');
                        }
                        else if(!empty($detailID)){
                            require_once('components/company/view/_company_details.php');
                        }
                        else{
                            require_once('components/company/view/_company.php');
                        }
                    ?>
                </div>
    ...
    <?php
        $scriptLink = 'company.js';

        if($newRecord){
            $scriptLink = 'company-new.js';
        }
        else if(!empty($detailID)){
            $scriptLink = 'company-details.js';
        }

        echo '<script src="./components/company/js/'. $scriptLink .'?v=' . rand() .'"></script>';
    ?>
</body>
