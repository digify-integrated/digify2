...
<body>
            ...
            <div class="body-wrapper">
                <div class="container-fluid">
                    <?php 
                        ...
                        if($newRecord){
                            require_once('components/schedule-type/view/_schedule_type_new.php');
                        }
                        else if(!empty($detailID)){
                            require_once('components/schedule-type/view/_schedule_type_details.php');
                        }
                        else{
                            require_once('components/schedule-type/view/_schedule_type.php');
                        }
                    ?>
                </div>
    ...
    <?php
        $scriptLink = 'schedule-type.js';

        if($newRecord){
            $scriptLink = 'schedule-type-new.js';
        }
        else if(!empty($detailID)){
            $scriptLink = 'schedule-type-details.js';
        }

        echo '<script src="./components/schedule-type/js/'. $scriptLink .'?v=' . rand() .'"></script>';
    ?>
</body>
