...
<body>
            ...
            <div class="body-wrapper">
                <div class="container-fluid">
                    <?php 
                        ...
                        if($newRecord){
                            require_once('components/language/view/_language_new.php');
                        }
                        else if(!empty($detailID)){
                            require_once('components/language/view/_language_details.php');
                        }
                        else{
                            require_once('components/language/view/_language.php');
                        }
                    ?>
                </div>
    ...
    <?php
        $scriptLink = 'language.js';

        if($newRecord){
            $scriptLink = 'language-new.js';
        }
        else if(!empty($detailID)){
            $scriptLink = 'language-details.js';
        }

        echo '<script src="./components/language/js/'. $scriptLink .'?v=' . rand() .'"></script>';
    ?>
</body>
