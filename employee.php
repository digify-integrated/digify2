...
<body>
            ...
            <div class="body-wrapper">
                <div class="container-fluid">
                    <?php 
                        ...
                        if($newRecord){
                            require_once('components/employee/view/_employee_new.php');
                        }
                        else if(!empty($detailID)){
                            require_once('components/employee/view/_employee_details.php');
                        }
                        else{
                            require_once('components/employee/view/_employee.php');
                        }
                    ?>
                </div>
    ...
    <?php
        ...
        if($newRecord){
            $scriptLink = 'employee-new.js';
        }
        else if(!empty($detailID)){
            $scriptLink = 'employee-details.js';
        }

        echo '<script src="./components/employee/js/'. $scriptLink .'?v=' . rand() .'"></script>';
    ?>
</body>
