...
<body>
            ...
            <div class="body-wrapper">
                <div class="container-fluid">
                    <?php 
                        ...
                        if($newRecord){
                            require_once('components/employment-location-type/view/_employment_location_type_new.php');
                        }
                        else if(!empty($detailID)){
                            require_once('components/employment-location-type/view/_employment_location_type_details.php');
                        }
                        else{
                            require_once('components/employment-location-type/view/_employment_location_type.php');
                        }
                    ?>
                </div>
    ...
    <?php
        $scriptLink = 'employment-location-type.js';

        if($newRecord){
            $scriptLink = 'employment-location-type-new.js';
        }
        else if(!empty($detailID)){
            $scriptLink = 'employment-location-type-details.js';
        }

        echo '<script src="./components/employment-location-type/js/'. $scriptLink .'?v=' . rand() .'"></script>';
    ?>
</body>
