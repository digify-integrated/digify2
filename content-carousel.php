...
<body>
            ...
            <div class="body-wrapper">
                <div class="container-fluid">
                    <?php 
                        ...
                        if($newRecord){
                            require_once('components/content-carousel/view/_content_carousel_new.php');
                        }
                        else if(!empty($detailID)){
                            require_once('components/content-carousel/view/_content_carousel_details.php');
                        }
                        else{
                            require_once('components/content-carousel/view/_content_carousel.php');
                        }
                    ?>
                </div>
    ...
    <?php
        $scriptLink = 'content-carousel.js';

        if($newRecord){
            $scriptLink = 'content-carousel-new.js';
        }
        else if(!empty($detailID)){
            $scriptLink = 'content-carousel-details.js';
        }

        echo '<script src="./components/content-carousel/js/'. $scriptLink .'?v=' . rand() .'"></script>';
    ?>
</body>
