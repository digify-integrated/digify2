...
<body>
            ...
            <div class="body-wrapper">
                <div class="container-fluid">
                    <?php 
                        ...
                        if($newRecord){
                            require_once('components/services-box/view/_services_box_new.php');
                        }
                        else if(!empty($detailID)){
                            require_once('components/services-box/view/_services_box_details.php');
                        }
                        else{
                            require_once('components/services-box/view/_services_box.php');
                        }
                    ?>
                </div>
    ...
    <?php
        $scriptLink = 'services-box.js';

        if($newRecord){
            $scriptLink = 'services-box-new.js';
        }
        else if(!empty($detailID)){
            $scriptLink = 'services-box-details.js';
        }

        echo '<script src="./components/services-box/js/'. $scriptLink .'?v=' . rand() .'"></script>';
    ?>
</body>
