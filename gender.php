...
<body>
            ...
            <div class="body-wrapper">
                <div class="container-fluid">
                    <?php 
                        ...
                        if($newRecord){
                            require_once('components/gender/view/_gender_new.php');
                        }
                        else if(!empty($detailID)){
                            require_once('components/gender/view/_gender_details.php');
                        }
                        else{
                            require_once('components/gender/view/_gender.php');
                        }
                    ?>
                </div>
    ...
    <?php
        $scriptLink = 'gender.js';

        if($newRecord){
            $scriptLink = 'gender-new.js';
        }
        else if(!empty($detailID)){
            $scriptLink = 'gender-details.js';
        }

        echo '<script src="./components/gender/js/'. $scriptLink .'?v=' . rand() .'"></script>';
    ?>
</body>
