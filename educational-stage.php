...
<body>
            ...
            <div class="body-wrapper">
                <div class="container-fluid">
                    <?php 
                        ...
                        if($newRecord){
                            require_once('components/educational-stage/view/_educational_stage_new.php');
                        }
                        else if(!empty($detailID)){
                            require_once('components/educational-stage/view/_educational_stage_details.php');
                        }
                        else{
                            require_once('components/educational-stage/view/_educational_stage.php');
                        }
                    ?>
                </div>
    ...
    <?php
        $scriptLink = 'educational-stage.js';

        if($newRecord){
            $scriptLink = 'educational-stage-new.js';
        }
        else if(!empty($detailID)){
            $scriptLink = 'educational-stage-details.js';
        }

        echo '<script src="./components/educational-stage/js/'. $scriptLink .'?v=' . rand() .'"></script>';
    ?>
</body>
