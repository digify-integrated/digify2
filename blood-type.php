...
<body>
            ...
            <div class="body-wrapper">
                <div class="container-fluid">
                    <?php 
                        ...
                        if($newRecord){
                            require_once('components/blood-type/view/_blood_type_new.php');
                        }
                        else if(!empty($detailID)){
                            require_once('components/blood-type/view/_blood_type_details.php');
                        }
                        else{
                            require_once('components/blood-type/view/_blood_type.php');
                        }
                    ?>
                </div>
    ...
    <?php
        $scriptLink = 'blood-type.js';

        if($newRecord){
            $scriptLink = 'blood-type-new.js';
        }
        else if(!empty($detailID)){
            $scriptLink = 'blood-type-details.js';
        }

        echo '<script src="./components/blood-type/js/'. $scriptLink .'?v=' . rand() .'"></script>';
    ?>
</body>
