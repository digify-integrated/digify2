...
<body>
            ...
            <div class="body-wrapper">
                <div class="container-fluid">
                    <?php 
                        ...
                        if($newRecord){
                            require_once('components/contact-information-type/view/_contact_information_type_new.php');
                        }
                        else if(!empty($detailID)){
                            require_once('components/contact-information-type/view/_contact_information_type_details.php');
                        }
                        else{
                            require_once('components/contact-information-type/view/_contact_information_type.php');
                        }
                    ?>
                </div>
    ...
    <?php
        $scriptLink = 'contact-information-type.js';

        if($newRecord){
            $scriptLink = 'contact-information-type-new.js';
        }
        else if(!empty($detailID)){
            $scriptLink = 'contact-information-type-details.js';
        }

        echo '<script src="./components/contact-information-type/js/'. $scriptLink .'?v=' . rand() .'"></script>';
    ?>
</body>
